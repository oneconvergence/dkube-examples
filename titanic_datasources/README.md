...
1. Download [resources.ipynb](https://github.com/oneconvergence/dkube-examples/tree/monitoring/titanic_datasources/resources.ipynb)
...
1. From **workspace/monitoring-examples/titanic** open [modelmonitor.ipynb](https://github.com/oneconvergence/dkube-examples/tree/monitoring/titanic_datasources/modelmonitor.ipynb) and run all the cells. New model monitor will be created.
