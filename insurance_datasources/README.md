...
2. Create an IDE (JupyterLab)
   ...
   - **If your data is in SQL:**
     - Add the following environment variables with your secret values in configuration tab
       ...
       - DATABASENAME    
3. Click Submit.
4. From **workspace/insurance/insurance_datasources** open resources.ipynb and fill the following details in the first cell. 
...
1. From **workspace/insurance/insurance** open [modelmonitor.ipynb](https://github.com/oneconvergence/dkube-examples/tree/monitoring/insurance_datasources/modelmonitor.ipynb) and run all the cells. New model monitor will be created.
